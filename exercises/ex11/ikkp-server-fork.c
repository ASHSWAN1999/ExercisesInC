...
{
    char segfault[0] = "Let's cause a segfault!"; //the child process doesn't crash the server!
...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        if(fork() == 0) { //child process functionality
            close(listener_d); //closes parent port
